...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\CoreWP\DB\\EventHandler');
    ...
    {
        class_alias('CoreWP\DB\\src\\AliasFacade', $alias);

        $builder = $this->container->build('\\CoreWP\DB\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\CoreWP\DB\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
