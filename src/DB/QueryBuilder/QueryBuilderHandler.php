...
use CoreWP\DB\Connection;
use CoreWP\DB\Exception;
...
class QueryBuilderHandler
{
    ...
    /**
     * @var \CoreWP\DB\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\CoreWP\DB\Connection $connection
     *
     * @throws \CoreWP\DB\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\CoreWP\DB\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\CoreWP\DB\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\CoreWP\DB\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\CoreWP\DB\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\CoreWP\DB\\QueryBuilder\\Raw', array($value, $bindings));
    }
